...
class Case extends Component {
  render() {
    return (
      <section style={{width: 850, height: this.props.height, borderRadius: 6, margin: "0 auto"}}>
        ...
        <div style={{width: this.props.rightWidth, float: "left", backgroundImage: `url(${this.props.image})`, height: "100%", borderRadius: "0 6px 6px 0", backgroundSize: "cover"}}></div>
      </section>
    );
  }
}
